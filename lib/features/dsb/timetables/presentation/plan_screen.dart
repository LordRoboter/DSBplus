...
class PlanScreen extends ConsumerStatefulWidget {
  const PlanScreen({super.key, this.showAppBar = false});
...
class _PlanScreenState extends ConsumerState<PlanScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: showAppBar ? AppBar(title: Text(context.l10n.substPlan)) : null,
      body: settings.when(
          ...
          return dayDates.when(
            ...
            data: (availableDayDates) {
              final currentSelectedDayDate =
                  selectedDayDate ??
                  (availableDayDates.isNotEmpty
                      ? availableDayDates.first
                      : null);
              ...
              return timetables.when(
                ...
                data: (enhancedTimetables) {
                  ...
                  final sortedEntries = groupEntriesByDayDate(
                    enhancedTimetables,
                  );
